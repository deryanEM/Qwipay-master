...
//                            val message = data.getString("message")
                        ...
                        //Toast.makeText(this@BuyerTransactionActivity, "api $list", Toast.LENGTH_LONG).show()


                        listview_transaction.setLayoutManager(LinearLayoutManager(this@BuyerTransactionActivity))
                        listview_transaction.setAdapter(ViewNotifAdapter(this@BuyerTransactionActivity,list))
    ...
    override fun onBackPressed() {
        val dashboard = Intent(this@BuyerTransactionActivity, HomeUserActivity::class.java)
