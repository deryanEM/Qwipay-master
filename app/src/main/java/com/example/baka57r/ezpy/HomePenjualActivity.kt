...
class HomePenjualActivity : AppCompatActivity() {
    ...
    internal var images = intArrayOf(R.drawable.buyicon, R.drawable.icon_top_up,
            R.drawable.iconriwayat, R.drawable.icon_account)

    internal var title = arrayOf("Transaksi", "Isi saldo", "Riwayat", "QID")
...
//        value1 = intent.getStringExtra("param1")
        ...
        notif_button.setOnClickListener {
            intent = Intent(this, SellerTransactionActivty::class.java)
        ...
        gridviewHome.setOnItemClickListener(AdapterView.OnItemClickListener { parent, v, position, id -> Toast.makeText(this@HomePenjualActivity, "Image Position: $position", Toast.LENGTH_SHORT).show() })

        gridviewHome.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
            val intent: Intent
            when (position) {
                0 -> {
                    intent = Intent(this, InputNominal::class.java)
                    intent.putExtra("param1", value1)
                    intent.putExtra("param2", value2)
                    intent.putExtra("param3", value3)
                    intent.putExtra("param4", value4)
                ...
                1 -> {
                    intent = Intent(this, TopUpPenjual::class.java)
                    intent.putExtra("param1", value1)
                    intent.putExtra("param2", value2)
                    intent.putExtra("param3", value3)
                    intent.putExtra("param4", value4)
                ...
                2 -> {
                    ...
                    intent = Intent(this, ProfilPenjual::class.java)
                    intent.putExtra("param1", value1)
                    intent.putExtra("param2", value2)
                    intent.putExtra("param3", value3)
                    intent.putExtra("param4", value4)
...
//                        Toast.makeText(this@HomeUserActivity, "api $list", Toast.LENGTH_LONG).show()
                        ...
                        listview_transaction.setLayoutManager(LinearLayoutManager(this@HomePenjualActivity))
                        listview_transaction.setAdapter(ViewNotifAdapter(this@HomePenjualActivity,list))
